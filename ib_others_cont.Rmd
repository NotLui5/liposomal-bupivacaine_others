...
<summary><b>Figure A -</b> Pain & Dose of opiod rescue medication with liposomal
bupivacaine vs others </summary>
<br>

```{r cont_graphs, echo=FALSE, fig.height = 6.5, fig.width = 13}
...
sizes_cont <- c(rep(NA,3), 0.005*(pof$pre$weights),1,
                rep(NA, 4), 0.005*(odf$pre$weights),1,
                rep(NA, 2))
