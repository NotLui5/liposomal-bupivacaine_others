...
```{r function, echo=FALSE, message=FALSE, warning=FALSE}
  db1 <- db1[order(db1$yi),]
  db1 <- summary(db1)
  
  db1$md <- paste(formatC(db1$yi, format='f', digits =1)," ",
                 "(",formatC(db1$ci.lb, format='f', digits =1),
                 ",",formatC(db1$ci.ub, format='f', digits=1),")") 
  db1$postmean1 <- paste(formatC(db1$mean_post1, format='f', digits=1),'(', formatC(db1$sd_post1, format='f', digits=1),')')
  db1$postmean2 <- paste(formatC(db1$mean_post2, format='f', digits=1),'(', formatC(db1$sd_post2, format='f', digits=1),')')
