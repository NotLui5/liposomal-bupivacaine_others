...
cf <- structure(list(
          mean = c(rep(NA, 2), exp(dat_v$yi), 2, NA, exp(dat_p$yi), meta_p$pred,NA),
          lower = c(rep(NA, 2), exp(dat_v$ci.lb), 0.1, NA, exp(dat_p$ci.lb), meta_p$ci.lb, NA),
          upper = c(rep(NA, 2), exp(dat_v$ci.ub), 95, NA, exp(dat_p$ci.ub), meta_p$ci.ub, NA)),
          .Names = c("mean", "lower", "upper"),
          row.names = c(NA, -1L*nrow(text1f)),
          class = "data.frame")

sizes1f <- c(NA, NA, (weights(meta_datv_reml)*0.01), 1,
