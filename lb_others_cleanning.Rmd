...
cont1<- cont1[-c(2,5:25,29:34,44,45), ]
rownames(cont1) <- NULL
cont1[is.na(cont1$mean1) & is.na(cont1$median1),]
cont1[is.na(cont1$sd) & is.na(cont1$iqr1),]
```
...
# Poner 0 como NA
table(dic1$e1)
dic1$e1[dic1$e1 == '0'] <- NA
table(dic1$e1, useNA = "ifany") 

table(dic1$e2)
dic1$e2[dic1$e2 == '0'] <- NA
table(dic1$e2, useNA = "ifany") 
